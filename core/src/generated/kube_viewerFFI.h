...
void ffi_kube_viewer_fdf3_RustGlobalViewModel_object_free(
      void*_Nonnull ptr,
    RustCallStatus *_Nonnull out_status
    );
void*_Nonnull kube_viewer_fdf3_RustGlobalViewModel_new(
...
void ffi_kube_viewer_fdf3_RustMainViewModel_object_free(
      void*_Nonnull ptr,
    RustCallStatus *_Nonnull out_status
    );
void*_Nonnull kube_viewer_fdf3_RustMainViewModel_new(
      RustBuffer window_id,
    RustCallStatus *_Nonnull out_status
    );
void kube_viewer_fdf3_RustMainViewModel_add_update_listener(
...
void ffi_kube_viewer_fdf3_RustNodeViewModel_object_free(
      void*_Nonnull ptr,
    RustCallStatus *_Nonnull out_status
    );
void*_Nonnull kube_viewer_fdf3_RustNodeViewModel_new(
      RustBuffer window_id,
    RustCallStatus *_Nonnull out_status
    );
void kube_viewer_fdf3_RustNodeViewModel_add_callback_listener(
      void*_Nonnull ptr,uint64_t responder,
    RustCallStatus *_Nonnull out_status
    );
void ffi_kube_viewer_fdf3_FocusRegionHasher_object_free(
      void*_Nonnull ptr,
    RustCallStatus *_Nonnull out_status
    );
void*_Nonnull kube_viewer_fdf3_FocusRegionHasher_new(
...
void ffi_kube_viewer_fdf3_NodeViewModelCallback_init_callback(
      ForeignCallback  _Nonnull callback_stub,
    RustCallStatus *_Nonnull out_status
    );
void ffi_kube_viewer_fdf3_MainViewModelUpdater_init_callback(
      ForeignCallback  _Nonnull callback_stub,
    RustCallStatus *_Nonnull out_status
    );
RustBuffer ffi_kube_viewer_fdf3_rustbuffer_alloc(
      int32_t size,
    RustCallStatus *_Nonnull out_status
    );
RustBuffer ffi_kube_viewer_fdf3_rustbuffer_from_bytes(
      ForeignBytes bytes,
    RustCallStatus *_Nonnull out_status
    );
void ffi_kube_viewer_fdf3_rustbuffer_free(
      RustBuffer buf,
    RustCallStatus *_Nonnull out_status
    );
RustBuffer ffi_kube_viewer_fdf3_rustbuffer_reserve(
